...
replicateSimulations<-3	# number of simulations per parameter setting
...
par(las=1, lend=1)
plot(-10:20, meansNocut, col=stratCols[4], pch=16, cex=1.5, ylim=c(0,1), 
	main='age-based learning', xlab='preferred age difference', ylab='mean payoff')
lines(-10:20, meansNocut, col=stratCols[4])
